 ...
 * parser.
 * 遇到分析错误时引发此异常。
 * 通过在生成的解析器中调用 generateParseException 方法，可以显式创建此异常类型的对象。
 * <p/>
...
public class ParseException extends Exception {
     ...
     * 此构造函数由生成的解析器中的方法“generateParseException”使用
     * 调用此构造函数将生成此类型的新对象，并设置字段“currentToken”、“expectedTokenSequences”和“TOKEN\u IMAGE”。
     */
     ...
     * string literal.
     * 当原始版本不能用作ASCII字符串文字的一部分时，用于将原始字符转换为其转义版本。
     */
