 ...
 * 此类定义了要实现的合约接口，允许第三方供应商使用自定义消息存储。
 */
public interface MessageStore {
     ...
     * 从 queueId 开始，最多查询属于 topic 的 maxMsgNums 条消息
     * from given <code>offset</code>. Resulting messages will further be screened using provided message filter.
     * 来自给定的 offset。将使用提供的消息过滤器进一步筛选结果消息。
     *
     ...
     * 获取 messageStore 的 BrokerStatsManager。
     *
