...
public class DLedgerCommitLog extends CommitLog {
    ...
    // id 意味着 broker 角色，0 为 master，其他为 slave
    ...
    // 此偏移将旧 commitlog 与 dledger commitlog 分开
    ...
    private void recover(long maxPhyOffsetOfConsumeQueue) {
        ...
        //表示首次加载混合commitlog，需要恢复旧commitlog
    ...
    class MessageSerializer {
        ...
        // The maximum length of the message  消息的最大长度
        ...
        public EncodeResult serialize(final MessageExtBrokerInner msgInner) {
            ...
            // Exceeds the maximum message   超过最大消息数
            ...
            // Initialization of storage space  存储空间的初始化
